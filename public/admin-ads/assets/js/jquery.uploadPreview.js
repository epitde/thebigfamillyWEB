            ...
            if (files.length > 0) {
              ...
              reader.addEventListener("load",function(event) {
                ...
                if (file.type.match('image')) {
                  ...
                  $(settings.preview_box).find('video').remove();
                  $(settings.preview_box).append("<video controls><source src='" + loadedFile.result + "' type='" + file.type + "' />Your browser does not support the audio element.</video>");
                } else {
