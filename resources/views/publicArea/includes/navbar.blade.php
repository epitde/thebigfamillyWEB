        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item px-1"><a class="nav-link link-scroll active" href="#hero">Home <span
                                class="sr-only">(current)</span></a></li>
                    <li class="nav-item px-1"><a class="nav-link link-scroll" href="#about">About</a></li>
                    <li class="nav-item px-1"><a class="nav-link link-scroll" href="#services">Services</a></li>
                    <li class="nav-item px-1"><a class="nav-link link-scroll" href="#testimonials">Testimonials</a></li>
                    @if (Auth::user())
