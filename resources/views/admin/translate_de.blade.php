...
@section('title', 'Translation : English to German')
@section('content_header')
<h3>Translation : English to German</h3>
@stop
@section('content')
<div class="row">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">DE VALUE</th>
                            <th scope="col">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($langDataDE['GENERAL'] as $key => $general)
                        <tr>
                            ...
                            <td>
                                <a id="de_save_btn_{{$key}}GENERAL" class="btn btn-primary btn-sm"
                                    href="javascript:void(0)" data-toggle="tooltip" title="Update DE value"
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($langDataDE['HOME'] as $key => $home)
                        <tr>
                            <th scope="row" style="display:none">{{$key}}</th>
                            <td>
                            ...
                            <td>
                                <a id="de_save_btn_{{$key}}HOME" class="btn btn-primary btn-sm"
                                    href="javascript:void(0)" data-toggle="tooltip" title="Update DE value"
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($langDataDE['LOGIN'] as $key => $login)
                        <tr>
                            <th scope="row" style="display:none">{{$key}}</th>
                            <td>
                            ...
                            <td>
                                <a id="de_save_btn_{{$key}}LOGIN" class="btn btn-primary btn-sm"
                                    href="javascript:void(0)" data-toggle="tooltip" title="Update DE value"
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($langDataDE['POST'] as $key => $post)
                        <tr>
                            <th scope="row" style="display:none">{{$key}}</th>
                            <td>
                            ...
                            <td>
                                <a id="de_save_btn_{{$key}}POST" class="btn btn-primary btn-sm"
                                    href="javascript:void(0)" data-toggle="tooltip" title="Update DE value"
    ...
    function changeData(key, id, array_key) {
        ...
        $.ajax({
            ...
            success: function (response) {
                $('#de_save_btn_' + key + array_key).html("Saved").removeClass('btn-primary').addClass('btn-success');
                setTimeout(() => {
                    $('#de_save_btn_' + key + array_key).html("Save").removeClass('btn-success').addClass('btn-primary');
                }, 2000);
            }
        });
    }
