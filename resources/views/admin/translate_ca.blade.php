    ...
    function changeData(key, id, array_key) {
        ...
        $.ajax({
            ...
            success: function (response) {
                $('#ca_save_btn_' + key + array_key).html("Saved").removeClass('btn-primary').addClass('btn-success');
                setTimeout(() => {
                    $('#ca_save_btn_' + key + array_key).html("Save").removeClass('btn-success').addClass('btn-primary');
                }, 2000);
            }
        });
    }
