...
<head>
    ...
        <title>Assigning Translator</title>
       
    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en"
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <p>
                    ...
                    You were assigned to the language {{$language->name}}.<br>
                    Click the link below if you want to reject this request.
                </p>
                ...
                <a href="{{url('emails/reject/request/' . base64_encode($user->id) . '/'. base64_encode($language->id))}}"
                    style="color: #B200FD; text-decoration: underline;">
                    Reject request
                </a>
                <!--[if (gte mso 9)|(IE)]>
                </td></tr></table>
        ...
        <footer>
            ...
            <address style="font-size: 16px; font-style: normal; font-weight: 400; line-height: 24px;">
                <strong>Company</strong> 1234 Main Street, Anywhere, US 56789
            </address>
        </footer>
