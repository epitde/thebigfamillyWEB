...
class FileService
{
    ...
    protected $upload_path_2;

    public function __construct()
    {
        $this->upload_path_2 = Config::get('filesystems.upload_path_2');
    }
    ...
    public function up($file)
    {
        ...
        if ($file->move($this->upload_path_2 . '/', $renamed_uploaded_file)) {
